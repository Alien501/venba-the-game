    ...
    return(
        <>
            <div className="play-section-wrapper">
                ...
                <div className="play-dev-icon-container">
                    <a target='_' href="https://store.steampowered.com/app/1491670/Venba/" className="play-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-steam" viewBox="0 0 16 16">
                    ...
                    <a target='_' href="https://www.nintendo.com/en-ca/store/products/venba-switch/" className="play-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-nintendo-switch" viewBox="0 0 16 16">
                    ...
                    <a target='_' href="https://store.playstation.com/en-us/concept/10004312" className="play-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-playstation" viewBox="0 0 16 16">
                    ...
                    <a target='_' href="https://www.xbox.com/en-US/games/store/venba/9P5P55S7HB9S" className="play-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-xbox" viewBox="0 0 16 16">
            ...
            <div className="play-section-trigger"></div>
        </>
    )
};
